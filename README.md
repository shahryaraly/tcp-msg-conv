...
<!-- ABOUT THE PROJECT -->
## Intro
client server sms conversation built using Visual Studio 2010 IDE & C# Network Programming.

1. network enabled
2. two player sms conversation
3. sms received notification
...
2. Clone the repo
   ```sh
   git clone https://github.com/shahryaraly/tcp-msg-conv
   ```
